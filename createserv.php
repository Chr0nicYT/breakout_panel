...
<div class="app-cam">
          <form method="post" action="">
                ...
                Server Name: <input type="text" class="text" id="name" name="servname">        

                Server Jar (Include .jar extension): <input type="text" class="text" name="servjar">  
                
Server Port: <input type="text" class="text" name="servport">       

RCON Port: <input type="text" class="text" name="servrcon">            

RCON Password: <input type="text" class="text" name="rconpass">            


Server RAM (IN MB): <input type="text" class="text" name="servram">

<div class="submit"><input name="create" type="submit" value="Create"></div>
