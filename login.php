...
-->
<?php
include('loginit.php'); // Includes Login Script
...
<body id="login">
  ...
  <div class="app-cam">
	  <form action="" method="post">
		<input type="text" class="text" id="name" name="username" value="Username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Username';}">
