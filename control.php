            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href=“control.php"><i class="fa fa-dashboard fa-fw nav_icon"></i>Control Server</a>
                        </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
...
Server Name: <input type="text" class="text" name="cname">

<div class="submit"><input name="control" type="submit" value="Control"></div>
